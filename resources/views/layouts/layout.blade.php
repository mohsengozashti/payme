...
<div id="kt_header_mobile" class="header-mobile header-mobile-fixed">
    <div class="d-flex align-items-center">
        ...
        <a href="index.html" class="mr-7">
            <img alt="Logo" src="{{asset('assets/media/svg/flags/209-indonesia.svg')}}" class="max-h-30px" />
        </a>
        <!--end::Logo-->
        <!--begin::Dropdown-->
                    ...
                    <div class="container">
                        ...
                        <div class="d-none d-lg-flex align-items-center mr-3">
                            ...
                            <a href="index.html" class="mr-10">
                                <img alt="Logo" src="{{asset('assets/media/svg/flags/209-indonesia.svg')}}" class="max-h-35px" />
                            </a>
                            <!--end::Logo-->
                            <!--begin::Dropdown-->
...
{{--                            </div>--}}
                        ...
                        <div class="topbar">
                            <form action="{{route('logout')}}" method="POST">
                                @csrf
                            <button type="submit" class="btn btn-sm btn-info font-weight-bolder py-2 px-5">Sign Out</button>
                            </form>
                        </div>
                        <!--end::Topbar-->
                    </div>
