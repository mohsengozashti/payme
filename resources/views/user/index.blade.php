    ...
    <div class="container">
        ...
        <div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
            ...
            <div class="alert-text">
                <p>The Metronic Datatable allows flexible customization of its rows cells by exposing datatable and column schema object onto a callback function. In this example we shown how you can customize specific cell appearance using the datatable cell renderer callback function.</p>For more information visit
